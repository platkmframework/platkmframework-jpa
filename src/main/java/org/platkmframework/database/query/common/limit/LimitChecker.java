...
public class LimitChecker {
     ...
     * @param obj obj
     * @return boolean
     * @throws LimitExceededException LimitExceededException
     */
    public boolean check(Object obj) throws LimitExceededException {
        if (obj.getClass().isAnnotationPresent(ApplicationLimit.class)) {
            ...
            if (!limit.check(obj))
                throw new ApplicationLimitException("No se pueden crear m�s registros en este proceso, por exceder el l�mite permitido");
        }
        return true;
    }
}
