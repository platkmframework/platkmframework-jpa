 ...
 *         &lt;element ref="{}QuerySelect" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = { "id", "name", "createdBy", "createdDate", "querySelect" })
@XmlRootElement(name = "QueriesGroup")
public class QueriesGroup {
    ...
    /**
     * Atributo querySelect
     */
    @XmlElement(name = "QuerySelect", required = true)
    protected List<QuerySelect> querySelect;
     ...
     * @return List
     */
    public List<QuerySelect> getQuerySelect() {
        if (querySelect == null) {
            querySelect = new ArrayList<QuerySelect>();
        }
