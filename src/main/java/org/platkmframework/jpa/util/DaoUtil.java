...
public class DaoUtil {
    ...
    /**
     * getColumnsName
     * @param coumnsInfoValue coumnsInfoValue
     * @return List
     */
    public static List<String> getColumnsName(List<ColumnInfoValue> coumnsInfoValue) {
        return coumnsInfoValue.stream().map(ColumnInfoValue::getName).collect(Collectors.toList());
    }

    /**
     * getColumnsNameString
     * @param coumnsInfoValue coumnsInfoValue
     * @return String
     */
    public static String getColumnsNameString(List<ColumnInfoValue> coumnsInfoValue) {
        List<String> namesList = coumnsInfoValue.stream().map(ColumnInfoValue::getName).collect(Collectors.toList());
        return Util.listToStringComa(namesList);
    }

    /**
     * isEntityAnnotationPresent
     * @param entity entity
     * @return boolean
     */
